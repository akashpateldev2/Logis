...
function register_myheader_settings() 
{
    ...
    register_setting( 'my-own-theme-options-for-header', 'logo_text_val' );
}
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <label for="logo_text_val">Logo Text</label>
                        <input id="logo_text_val" type="text" name="logo_text_val" value="<?php echo get_option('logo_text_val'); ?>" class="form-control" />
